...
function About() {
  return (
    <div className='bg-white px-4 sm:px-6 md:px-8 lg:px-24 py-8'>
      ...
      {/* Content Container */}
      <div className='bg-bodyColor2 w-full max-w-[1248px] h-auto mx-auto my-8 md:my-[90px] rounded-[12px] p-6 md:p-12 flex flex-col md:flex-row gap-8 md:gap-16'>
        {/* Text Content */}
        <div className='flex-1 flex flex-col justify-between min-h-[300px] md:min-h-[350px]'>
          <div>
            <h1 className='pb-4 text-2xl sm:text-3xl md:text-4xl lg:text-[33.9px] font-semibold leading-tight text-white'>
          ...
          <div className='mt-auto self-start'>
            <button className="bg-white text-bodyColor2 font-semibold px-6 py-3 md:px-8 md:py-4 rounded-md hover:bg-slate-300 transition-colors text-base sm:text-lg md:text-xl w-full sm:w-auto">
              Read More
            </button>
          </div>
        </div>
        ...
        <div className='flex-1 flex justify-center md:justify-end items-center'>
          <img 
            src={image3} 
            alt="A+ image" 
            className='w-full max-w-[400px] md:max-w-[495px] h-auto object-cover rounded-lg shadow-xl'
          />
        </div>
      </div>
    </div>

...
function drive() {
  return (
    <section className="bg-white h-screen flex flex-col items-start px-6 sm:px-10 md:flex-col md:text-left mb-40">
    ...
    <span className="text-gray-300">What </span>
      ...
      <div className="mt-8 p-6 md:p-20 bg-[#EBF5F3] rounded-lg shadow-md max-w-5xl mx-auto grid gap-6 md:gap-16  grid-cols-1 md:grid-cols-3 md:mb-60">

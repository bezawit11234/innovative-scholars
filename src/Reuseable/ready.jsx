    ...
    return (
        <div className='bg-bodyColor2 py-12 md:py-20 flex flex-col items-center text-center w-full mb-0 pb-0 '>
          <div className='w-full max-w-6xl px-2 md:px-6'>
            ...
            <button className="bg-buttonColor text-white h-14 md:h-[40px] w-48 md:w-[157.92999267578125px] rounded-md hover:bg-green-600 transition-colors text-lg md:text-xl mt-2 md:mt-4 mb-7">
              Get Started
            </button>
          </div>
        </div>
